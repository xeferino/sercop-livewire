<div class="md:hidden">
    <div class="fixed inset-0 flex z-40" x-show="open">
        <div class="fixed inset-0" aria-hidden="true" x-show="open">
        <div class="absolute inset-0 bg-gray-600 opacity-75"></div>
        </div>

        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white" x-show="open">
        ...
        <div class="mt-5 flex-1 h-0 overflow-y-auto">
            ...
            @can('show-procedure')
                <a href="{{ route('admin.procedures.index') }}" class="{{  request()->routeIs('admin.procedures.*') ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-base font-medium rounded-md">
                    <svg class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64">
        ...
        <div class="mt-5 flex-grow flex flex-col">
            ...
            @can('show-procedure')
                <a href="{{ route('admin.procedures.index') }}" class="{{  request()->routeIs('admin.procedures.*') ? 'bg-gray-100 text-gray-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                    <svg class="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                    </svg>
                    Procedimientos
