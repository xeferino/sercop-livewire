          ...
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <label for="name" class="block text-sm font-medium text-gray-700">Etapa</label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="type_procedure_id" class="block text-sm font-medium text-gray-700">Procedimiento</label>
                        <select wire:model="type_procedure_id" class="mt-1 block w-full py-2 px-3 border {{ $errors->has('type_procedure_id') ? ' border-red-500' : 'border-gray-300' }} bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
