                                    ...
                                    <div class="rounded-md bg-gray-50 p-4">
                                        <div class="relative flex items-start">
                                            <div class="flex items-center h-5">
                                                <input id="syncPermissions-{{ $item->id }}" name="syncPermissions[]" value="{{ $item->id }}"  {{ (is_array(old('syncPermissions')) and in_array($item->id , old('syncPermissions'))) ? ' checked' : '' }} type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                            </div>
